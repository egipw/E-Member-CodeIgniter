  ...
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-body">
        ...
        <form id="form_ubah" method="post" action="<?php echo base_url('member/bayar/aksi_upload'); ?>" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id_user" value="<?php echo $data->id_user;?>">
          ...
          <div class="tile-footer">
            ...
            &nbsp;&nbsp;&nbsp;
            <a class="btn btn-secondary" href="<?php echo base_url('profil/member'); ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Batal</a> <input type="submit" id="submit_ubah" style="visibility: hidden;">
          </div>
        </form>
      </div>
    </div>
