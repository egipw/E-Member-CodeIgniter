      ...
      <div class="tile-body">
        <div class="tile-title-w-btn">
          <h3 class="title">Data Laporan Kegiatan</h3>
                <div class="row">
        <div align="right">
        <form name="form" id="form" role="form" method="post" action="<?php echo base_url('laporan_kegiatan/export_tanggal_pdf'); ?>">
   
            <input type='hidden' name='tanggal_dari' class='form-control' id='tanggal_dari' value="<?php echo $this->input->post('tanggal_dari'); ?>">
  
            <input type='hidden' name='tanggal_sampai' class='form-control' id='tanggal_sampai' value="<?php echo $this->input->post('tanggal_sampai'); ?>">

            <input type='hidden' name='id_kategori' class='form-control' id='id_kategori' value="<?php echo $this->input->post('id_kategori'); ?>">    
        ...
        <div class='col-sm-2'>
        <form name="form" id="form" role="form" method="post" action="<?php echo base_url('laporan_kegiatan/export_tanggal_excel'); ?>">
