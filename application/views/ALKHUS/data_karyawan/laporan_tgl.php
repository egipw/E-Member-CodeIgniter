      ...
      <div class="tile-body">
        <div class="tile-title-w-btn">
          <h3 class="title">Data karyawan</h3>
                <div class="row">
        <div align="right">
        <form name="form" id="form" role="form" method="post" action="<?php echo base_url('data_karyawan/export_tanggal_pdf'); ?>">
            <input type="hidden" name="id" name="id" value="<?php echo $this->input->post('id');; ?>">
        ...
        <div class='col-sm-2'>
        <form name="form" id="form" role="form" method="post" action="<?php echo base_url('data_karyawan/export_tanggal_excel'); ?>">
            <input type="hidden" name="id" name="id" value="<?php echo $this->input->post('id');; ?>">
            <input type='hidden' name='tanggal_dari' class='form-control' id='tanggal_dari' value="<?php echo $this->input->post('tanggal_dari'); ?>">
